...
The purpose of this project is to demonstrate the use of Rmarkdown to generate reports integrating text and R code with output [@xie2018r].
...
@tukey1977exploratory said exploring data is really important.
```{r}
